...
train_arg.add_argument('--init_lr', type=str2bool, default=False)
train_arg.add_argument('--d_lr', type=float, default=0.0002)
train_arg.add_argument('--g_lr', type=float, default=0.002)
train_arg.add_argument('--lr_lower_boundary', type=float, default=0.00002)
train_arg.add_argument('--beta1', type=float, default=0.5)
#train_arg.add_argument('--beta2', type=float, default=0.999)
train_arg.add_argument('--beta2', type=float, default=0.5)
